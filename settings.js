class SettingsApp
{
	...
	getElements()
	{
		return {
			...
			modelBoxes:
			{
				cerebras: document.getElementById('cerebrasModelContainer'),
				openai: document.getElementById('openaiModelContainer'),
				chutes: document.getElementById('chutesModelContainer'),
				anthropic: document.getElementById('anthropicModelContainer'),
				deepinfra: document.getElementById('deepinfraModelContainer'),
				...
				hyperbolic: document.getElementById('hyperbolicModelContainer'),
				minimax: document.getElementById('minimaxModelContainer'),
				ollama: document.getElementById('ollamaModelContainer'),
			...
			modelSelects:
			{
				cerebras: document.getElementById('cerebrasModel'),
				openai: document.getElementById('openaiModel'),
				chutes: document.getElementById('chutesModel'),
				anthropic: document.getElementById('anthropicModel'),
				deepinfra: document.getElementById('deepinfraModel'),
				...
				hyperbolic: document.getElementById('hyperbolicModel'),
				minimax: document.getElementById('minimaxModel'),
				ollama: document.getElementById('ollamaModel'),
